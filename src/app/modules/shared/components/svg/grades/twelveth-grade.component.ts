...
@Component({
  selector: 'app-twelveth-svg',
  standalone: true,
  template: `
    <svg width="30" height="30" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="grad-green" x1="0" y1="0" x2="50" y2="50">
      ...
      <circle cx="25" cy="25" r="22" fill="url(#grad-green)" stroke="#22C55E" stroke-width="2"/>
      ...
      <text x="25" y="28" text-anchor="middle" dominant-baseline="middle"
            ...
            filter="url(#text-shadow)">12
      </text>
    </svg>
  `
})
export class TwelvethComponent {}
