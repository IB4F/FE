...
export const APIS = [AdminDashboardService, AdminUserService, AuthService, DashboardService, DetailsService, FileService, LearnHubsService, LinksService, ProgressService, QuizzesService, StudentService, SubscriptionService, SubscriptionPackageService, SupervisorService];
